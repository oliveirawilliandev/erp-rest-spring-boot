...
import br.com.willian.repository.UserRepository;
...
public class JwtTokenProvider {
    ...
    public TokenDTO createAccessToken(String username, List<String> roles, String fullName, String photoUrl) {
        ...
        return new TokenDTO(username, true, now, validity, accessToken, refreshToken,fullName, photoUrl);
    ...
    public TokenDTO refreshAccessToken(String refreshToken) {
        ...
        // Buscar o fullName do usuário no banco de dados
        ...
        return createAccessToken(username, roles, fullName,photoUrl); // Cria novo access token
    }
