...
class EmployeeControllerYamlTest extends AbstractIntegrationTest { // Base comum de testes com container
    ...
    void createWithAllowedOrigin() throws JsonProcessingException {
        ...
        var content = given().config(
                ...
                .body()  // acessa body
                .as(EmployeesDTO.class, objectMapper);  // desserializa o body da resposta para EmployeeDTO usando o ObjectMapper informado
     ...
     * see EmployeeDTO DTO do funcionário
     *
    ...
    void findAllWithAllowedOrigin() throws JsonProcessingException {
        ...
        var content = given().config(
                ...
                .extract()  // extrai resposta
                .body()  // acessa body
                .as(PageModelEmployeesYAML.class, objectMapper);  // desserializa o body da resposta para EmployeeDTO usando o ObjectMapper informado
