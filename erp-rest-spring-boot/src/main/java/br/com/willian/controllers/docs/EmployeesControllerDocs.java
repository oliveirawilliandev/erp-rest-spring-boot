...
import br.com.willian.dto.EmployeesDTO;
...
public interface PersonControllerDocs {
    ...
    EmployeesDTO create(@RequestBody EmployeesDTO person);
    ...
    EmployeesDTO update(@RequestBody EmployeesDTO person);
    ...
    EmployeesDTO disablePerson(@PathVariable("id") Long id);
